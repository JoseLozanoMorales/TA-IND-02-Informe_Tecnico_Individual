...
% Inserta una captura si existe; en caso contrario muestra un recuadro pendiente.
\newcommand{\evidencia}[3]{%
  \begin{figure}[H]
    \centering
    \IfFileExists{evidencias/#1}{%
      \includegraphics[width=0.92\textwidth,height=0.68\textheight,keepaspectratio]{evidencias/#1}%
    }{%
